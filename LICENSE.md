Понял. Приношу извинения за неточности в форматировании. Я полностью перепроверил и исправил руководство, уделив особое внимание тому, чтобы **весь код без исключения** находился внутри блоков ```.

Вот финальная, абсолютно точная версия.
