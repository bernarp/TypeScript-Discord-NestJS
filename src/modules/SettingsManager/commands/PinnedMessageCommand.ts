...
import { Permissions } from "@settings/permissions.dictionary";
...
export class PinnedMessageCommand implements ICommand {
    ...
    private async _handleDelete(
        ...
        // Получаем информацию о панели до удаления из конфигурации
        ...
        // Пытаемся удалить само сообщение из Discord
        ...
        // Формируем сообщение об успехе с учетом результата удаления сообщения
