...
import { IConfigurationService } from "./core.DiscordClient/abstractions/interface/config/IConfigurationService";
    ...
    static forRootAsync(logger: ILogger): DynamicModule {
        ...
        const permissionRepositoryProvider = {
            ...
            useFactory: async (
                ...
                const repo = new PermissionRepository(storage, logger);
                await repo.init();
                return repo;
            },
            inject: ["GuildConfigStorageStrategy", "ILogger"],
