 ...
 * @version 3.4: Добавлена реализация метода deletePinnedMessage.
 * @author System
 */
...
export class ConfigurationService implements IConfigurationService {
    ...
    public async getAllGuildConfigs(): Promise<[string, IGuildSettings][]> {
        return Array.from(this._guildsCache.entries());
    }
    ...
    public async deletePinnedMessage(
        ...
        const updatedSettings: IGuildSettings = {
            ...currentSettings,
            pinnedMessages: remainingPinnedMessages,
        };
