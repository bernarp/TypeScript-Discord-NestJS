...
Этот документ описывает архитектуру и структуру Discord-бота, построенного с использованием фреймворка **NestJS** и библиотеки **discord.js**. Проект спроектирован с упором на модульность, слабую связанность компонентов, расширяемость и удобство поддержки, следуя лучшим практикам и принципам SOLID.
